...
const Navbar = ()  => {
  ...
  return (
    <nav className=':uno: flex pt-[16.5px] xl:mx-0 justify-between items-center  sm:pl-[40px] ss:pl-[35px] md:pl-[55px] lg:pl-[75px] pl-[15px] pr-[25px] mx-auto  md:mx-0  mb-[50px] !w-[99%]'>
      <div>

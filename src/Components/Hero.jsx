...
function Hero() {
  return (
    ...
    <div className='text-white container font-sf-display flex flex-col z-10'>
      ...
      <span className='text-[#A0A3B5] text-[22px] mb-[30px] sm:mb-[40px] ss:w-[80%] sm:w-[65%]'>It's not only for pump and dump by Elon tweets. 
This is real NFT game with Achiements, Goals and nice gameplay with tokenization</span>
    <img 
    src={herobigshiba} 
    alt="heroShiba"
    className='mb-[50px] w-[200px] h-[180px] mx-auto ss:mx-0 ss:absolute ss:right-0 ss:left-[67%] sm:mx-0 sm:absolute sm:right-0 sm:left-[67%]'
    />

    <div className='mx-auto flex flex-col items-center ss:flex-wrap ss:flex-row ss:w-[100%] ss:justify-center'>

    <div className='mb-[55px] sm:mb-[30px] ss:w-[43.33%] sm:w-[34.33%] block'>
        ...
        <div className='border border-[#FFFFFF0D] rounded-[10px]  text-white text-[14px] font-medium items-center text-center bg-[#FFFFFF0D] mb-[34px] ss:w-[66.33%] sm:w-[56.33%] block'>
          <a href='#'>
